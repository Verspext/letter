(function(window){
    ...
    Heart = function() {
        // r = a * sin(2θ)
    // http://www.wolframalpha.com/input/?i=polar+plot+r+%3D+5*sin(2*theta)
    var points = [], x, y, t, a = 15;
    for (var i = 0; i <= 360; i += 1) {
        t = i * Math.PI / 180; // đổi sang radian
        var r = a * Math.sin(2 * t);
        x = r * Math.cos(t);
        y = r * Math.sin(t);
    ...
    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        this.tree = tree;
        this.point = point;
        this.color = color || 'rgb(' + random(130, 180) + ',' + random(190, 240) + ',' + random(70, 120) + ')';
